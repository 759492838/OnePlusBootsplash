...
post-fs-data.sh 和 zip 不能更改，这两个文件用于将 part0 文件中的开机二级动画写入配置文件
创建一个文件夹并命名为 part0，在这里你可以添加你想要的开机动画。当然，开机动画是图片格式的，你可以参考我做的这个：https://www.123865.com/s/FBIZVv-pjMGd
